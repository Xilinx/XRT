...
export XMA_INCLUDE=${XMA_INCLUDE:=${xrt_install_dir}/include}
export XMA_LIBS=${XMA_LIBS:=${xrt_install_dir}/lib}
...
export LD_LIBRARY_PATH=${xrt_install_dir}/lib
echo "LD_LIBRARY_PATH is $LD_LIBRARY_PATH"

source ${xrt_install_dir}/setup.sh
echo "LD_LIBRARY_PATH is $LD_LIBRARY_PATH"
