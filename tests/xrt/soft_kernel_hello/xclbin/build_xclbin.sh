...
xclbinutil --input ./dummy.xclbin --add-section SOFT_KERNEL[hello_world]-OBJ:RAW:./hello_world.so --add-section SOFT_KERNEL[hello_world]-METADATA:JSON:hello_world.rtd -o soft_kernel_hello_world.xclbin
