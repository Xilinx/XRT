...
/*
 * Basic loopback test. The OpenCL kernel returns the data sent to it. Test the full
 * system.
 */
...
int main(int argc, char** argv)
{
    ...
    try {
        ...
        for(int i = 0; i < iteration; i++)
        {
            ...
            clEnqueueReadBuffer(hardware.mQueue, deviceData.getSequence1(), CL_TRUE, 0, hostData.getLength(), hostData.getSequence1(), 0, 0, 0);
            /*
