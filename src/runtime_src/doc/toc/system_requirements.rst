...
Supported Xilinx® Accelerator Cards are listed in `platform <platform.rst>`_ .
...
To install XRT on the host, please refer to page `install <install.rst>`_. for dependencies installation steps and XRT installation steps.

To build a custom XRT package, please refer to page `build <build.rst>`_ for dependencies installation steps and building steps.
...
The embedded platform for deployment should have XRT and ZOCL installed. For details about building embedded platforms please refer to `yocto <yocto.rst>`_.
