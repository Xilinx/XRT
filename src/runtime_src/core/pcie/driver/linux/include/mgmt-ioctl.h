...
enum XCLMGMT_IOC_TYPES {
	...
	XCLMGMT_IOC_SOFTKERNEL_RESET,
	XCLMGMT_IOC_ERT_RESET,
	XCLMGMT_IOC_REBOOT,
...
#define XCLMGMT_IOCSKRESET		_IO(XCLMGMT_IOC_MAGIC, XCLMGMT_IOC_SOFTKERNEL_RESET)
#define XCLMGMT_IOCERTRESET		_IO(XCLMGMT_IOC_MAGIC, XCLMGMT_IOC_ERT_RESET)
