...
#ifndef LIBQDMA4_QDMA_DEVICE_H_
#define LIBQDMA4_QDMA_DEVICE_H_
/**
 * @file
...
/*****************************************************************************/
/**
 * qdma4_device_init() - initializes the qdma device
 *
 ...
 * @return	-1: failure
 *****************************************************************************/
int qdma4_device_init(struct xlnx_dma_dev *xdev);

/*****************************************************************************/
/**
 * qdma4_device_cleanup() - clean up the qdma device
 *
 * @param[in]	xdev:		pointer to xdev
 *
 * @return	none
 *****************************************************************************/
void qdma4_device_cleanup(struct xlnx_dma_dev *xdev);

/*****************************************************************************/
/**
 * qdma4_device_get_descq_by_id() - get the qhndl for descq
 *
 * @param[in]	xdev:	pointer to xdev
 ...
 * @return	<0 on failure
 *****************************************************************************/
long qdma4_device_get_id_from_descq(struct xlnx_dma_dev *xdev,
				   struct qdma_descq *descq);
/*****************************************************************************/
/**
 * qdma4_device_get_descq_by_id() - get the descq using the qid
 *
 * @param[in]	xdev:	pointer to xdev
...
/*****************************************************************************/
/**
 * qdma4_device_get_descq_by_hw_qid() - get the descq using the hw qid
 *
 * @param[in]	xdev:		pointer to xdev
 ...
 * @return	NULL on failure
 *****************************************************************************/
struct qdma_descq *qdma4_device_get_descq_by_hw_qid(struct xlnx_dma_dev *xdev,
			unsigned long qidx_hw, u8 c2h);

/*****************************************************************************/
/**
 * qdma4_device_prep_q_resource() - Prepare queue resources
 *
 * @param[in]	xdev:		pointer to xdev
 *
 * @return	0: success
 * @return	<0: failure
 *****************************************************************************/
int qdma4_device_prep_q_resource(struct xlnx_dma_dev *xdev);
...
/*****************************************************************************/
/**
 * qdma4_csr_read() - Read specific global csr registers
 *
 * @param[in]   xdev:           pointer to xdev
 ...
 * @return      <0: failure
 *****************************************************************************/
int qdma4_csr_read(struct xlnx_dma_dev *xdev, struct global_csr_conf *csr);
