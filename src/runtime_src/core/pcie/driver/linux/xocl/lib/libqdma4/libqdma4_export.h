...
#ifndef __LIBQDMA4_EXPORT_API_H__
#define __LIBQDMA4_EXPORT_API_H__
...
extern struct drv_mode_name qdma4_mode_name_list[];
...
/*****************************************************************************/
/**
 * qdma4_intr_legacy_init() - legacy interrupt init
 *
 *****************************************************************************/
//void qdma4_intr_legacy_init(void);
 ...
 *
 *****************************************************************************/
int qdma4_device_online(struct pci_dev *pdev, unsigned long dev_hndl,
					   int reset);
 ...
 *
 *****************************************************************************/
int qdma4_device_flr_quirk_set(struct pci_dev *pdev, unsigned long dev_hndl);
 ...
 *
 *****************************************************************************/
int qdma4_device_flr_quirk_check(struct pci_dev *pdev, unsigned long dev_hndl);
 ...
 * configures sriov
 *****************************************************************************/
int qdma4_device_sriov_config(struct pci_dev *pdev, unsigned long dev_hndl,
				int num_vfs);
 ...
 *
 *****************************************************************************/
int qdma4_device_read_config_register(unsigned long dev_hndl,
 ...
 *
 *****************************************************************************/
int qdma4_device_write_config_register(unsigned long dev_hndl,
					unsigned int reg_addr,
					unsigned int value);
 ...
 *
 *****************************************************************************/
int qdma4_device_version_info(unsigned long dev_hndl,
 ...
 *
 *****************************************************************************/
int qdma4_queue_set_err_induction(unsigned long dev_hndl, unsigned long id,
 ...
 *****************************************************************************/
int qdma4_queue_c2h_peek(unsigned long dev_hndl, unsigned long qhndl,
 ...
 *****************************************************************************/
int qdma4_queue_avail_desc(unsigned long dev_hndl, unsigned long qhndl);
 ...
 *
 *****************************************************************************/
int qdma4_queue_cmpl_ctrl(unsigned long dev_hndl, unsigned long qhndl,
 ...
 *
 *****************************************************************************/
int qdma4_queue_packet_read(unsigned long dev_hndl, unsigned long qhndl,
 ...
 *
 *****************************************************************************/
int qdma4_queue_packet_write(unsigned long dev_hndl, unsigned long qhndl,
			struct qdma_request *req);
 ...
 *
 *****************************************************************************/
int qdma4_descq_get_cmpt_udd(unsigned long dev_hndl, unsigned long qhndl,
		char *buf, int buflen);
 ...
 *
 *****************************************************************************/
int qdma4_descq_read_cmpt_data(unsigned long dev_hndl, unsigned long qhndl,
				u32 *num_entries,  u8 **cmpt_entries,
				char *buf, int buflen);

int qdma4_get_queue_count(unsigned long dev_hndl, struct qdma_queue_count *q_cnt,
				char *buf, int buflen);
#ifdef __QDMA_VF__
/*****************************************************************************/
/**
