...
struct qctx_entry qdma_s80_hard_sw_ctxt_entries[] = {
	{"PIDX", 0},
	{"IRQ Arm", 0},
	{"Queue Enable", 0},
...
struct qctx_entry qdma_s80_hard_hw_ctxt_entries[] = {
	{"CIDX", 0},
	{"Credits Consumed", 0},
...
struct qctx_entry qdma_s80_hard_credit_ctxt_entries[] = {
	{"Credit", 0},
};

struct qctx_entry qdma_s80_hard_cmpt_ctxt_entries[] = {
...
struct qctx_entry qdma_s80_hard_qid2vec_ctxt_entries[] = {
	{"c2h_vector", 0},
	{"c2h_en_coal", 0},
	{"h2c_vector", 0},
	{"h2c_en_coal", 0},
...
static unsigned int qdma_s80_hard_intr_context_buf_len(void)
{
	int len = 0;
		...
		char *buf, uint32_t buflen)
{
	...
	req_buflen = qdma_s80_hard_context_buf_len(st, q_type);
