...
/* Test the Mailbox Register Tx/Rx Interface*/
#define XCLMGMT_OID_MAILBOX_TEST       CTL_CODE(FILE_DEVICE_UNKNOWN, XCLMGMT_IOC_MAILBOX_TEST, METHOD_BUFFERED, FILE_ANY_ACCESS)
