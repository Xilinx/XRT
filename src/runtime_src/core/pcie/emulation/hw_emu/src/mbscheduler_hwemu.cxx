...
namespace hwemu {
    ...
    xocl_cu::xocl_cu(hwemu_shim* dev)
    {
        this->xdevice = dev;
        this->error = false;
        this->idx = 0;
    ...
    xocl_ert::xocl_ert(hwemu_shim* dev, uint64_t csr_base, uint64_t cq_base)
    {
        this->xdevice = dev;
    ...
    exec_core::exec_core(hwemu_shim* dev, xocl_scheduler* sched)
    {
    ...
    */
     ...
     */ 
    xocl_scheduler::xocl_scheduler(hwemu_shim* dev)
    {
        device = dev;
        error = false;
        stop = false;
