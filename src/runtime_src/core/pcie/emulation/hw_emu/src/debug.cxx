...
namespace xcl_hwemu_hal
{
  ...
  void hwemu_shim::readDebugIpLayout(const std::string debugFileName)
  {
    //
  ...
  uint32_t hwemu_shim::getIPCountAddrNames(const std::string debugFileName, int type, uint64_t *baseAddress,
  ...
  void hwemu_shim::fetchAndPrintMessages()
  {
   ...
   */
  void hwemu_shim::messagesThread()
  {
