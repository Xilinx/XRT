...
namespace hwemu {
    ...
    {
        public:
            xocl_cu(xcl_hwemu_hal::hwemu_shim* dev);
            ...
            xcl_hwemu_hal::hwemu_shim*  xdevice;
    ...
    {
        public:
            xocl_ert(xcl_hwemu_hal::hwemu_shim* dev, uint64_t csr_base, uint64_t cq_base);
            ~xocl_ert();
    ...
    {
        public:
            exec_core(xcl_hwemu_hal::hwemu_shim* dev, xocl_scheduler* sched);
    ...
    {
        public:
            xocl_scheduler(xcl_hwemu_hal::hwemu_shim* dev);
            ~xocl_scheduler();
            ...
            //! exec_core
            exec_core*  exec;
            xcl_hwemu_hal::hwemu_shim*   device;
