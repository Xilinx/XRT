...
namespace xclcpuemhal2 {
  ...
  struct sParseLog
  {
    ...
    //**********************************************************************************//
    /**
    * printMsg(std::string&) - Searches for a matchString in a file .
    * On a successfull match, it prints an actionable suggestion on the console.
    *
    * @matchString:    string to match
    * 
    */
    void printMsg(std::string &matchString) {
      std::string line;
    ...
    //**********************************************************************************//
    /**
    * parseLog() - Checks for file existence and calls printMsg .
    * 
    */
    void parseLog() {
      if (!mFileExists) {
      ...
      if (mFileExists) {
        std::string endOfSimulationString = "received request to end simulation from connected initiator";
        printMsg(endOfSimulationString);
      }
