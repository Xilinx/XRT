...
device_linux::get_sysdev_entry(QueryRequest qr) const
{
  ...
  static const std::map<QueryRequest, SysDevEntry> QueryRequestToSysDevTable =
  {
    ...
    { QR_DDR_TEMP_0,                {true, "xmc",  "xmc_ddr_temp0"}},
    { QR_DDR_TEMP_1,                {true, "xmc",  "xmc_ddr_temp1"}},
    { QR_DDR_TEMP_2,                {true, "xmc",  "xmc_ddr_temp2"}},
    { QR_DDR_TEMP_3,                {true, "xmc",  "xmc_ddr_temp3"}},
    { QR_HBM_TEMP,                  {true, "xmc",  "xmc_hbm_temp"}},
