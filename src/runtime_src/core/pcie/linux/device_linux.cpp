...
initialize_query_table()
{
  ...
  emplace_sysfs_get<query::xmc_scaling_threshold_power_override_en> ("xmc", "scaling_threshold_power_override_en");
  emplace_sysfs_get<query::xmc_scaling_threshold_temp_override_en>  ("xmc", "scaling_threshold_temp_override_en");
  emplace_sysfs_get<query::xmc_scaling_threshold_power_override>  ("xmc", "scaling_threshold_power_override");
  emplace_sysfs_get<query::xmc_scaling_threshold_temp_override>   ("xmc", "scaling_threshold_temp_override");
