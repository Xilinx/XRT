...
get_info(boost::property_tree::ptree& pt) const
{
  ...
  ptree_updater<query::edge_device>::query_and_put(this, pt);
  ptree_updater<query::edge_subsystem_vendor>::query_and_put(this, pt);
  ptree_updater<query::edge_subsystem_id>::query_and_put(this, pt);
}
