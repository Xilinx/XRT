...
//private
  ...
  int CpuemShim::xclLoadXclBinNewFlow(const xclBin *header)
  {
    ...
    if (header)
    {
      ...
      xclLoadBitstream_RPC_CALL(xclLoadBitstream, xmlFile, tempdlopenfilename, deviceDirectory, binaryDirectory, verbose, xmlbuff, xmllength, sharedlib, sharedliblength, emuData, emuDataSize);
      if (!ack)
        return -1;
    }
    return 0;
