 ...
 *
 * Caller get dma_handle from sched_cmd, then get dma_chan from
 * zocl_dma_channel_instance; caller can optionally set dma_func and dma_arg for
 * private usage.
 */
 ...
 * @dma_handle: zocl dma handler
 *
 * Common API for starting async DMA Engine. Current zocl dma only support
 * memcpy, can be enhanced for other type of DMAs when necessary.
 */
