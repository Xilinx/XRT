 ...
 * under the License.
 */
#ifndef _EDGE_SWEMU_SHIM_H_
#define _EDGE_SWEMU_SHIM_H_
...
namespace xcl_swemu_hal {
  ...
  public:
      ...
      ~swemu_shim();
      swemu_shim(unsigned int deviceIndex, xclDeviceInfo2 &info, std::list<xclemulation::DDRBank>& DDRBankList, bool bUnified, bool bXPR, FeatureRomHeader &featureRom );
