...
int
xclAIEOpenContext(xclDeviceHandle handle, const xuid_t xclbinUUID, xrt::aie::access_mode am);

int
xclAIECloseContext(xclDeviceHandle handle, const xuid_t xclbinUUID);
