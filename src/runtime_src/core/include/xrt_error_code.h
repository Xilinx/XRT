...
enum xrtErrorNum {
  ...
  XRT_ERROR_NUM_XCLBIN_INUSE,
  XRT_ERROR_NUM_XCLBIN_INCOMPATIBLE,
  XRT_ERROR_NUM_XCLBIN_INVALID,
  XRT_ERROR_NUM_XCLBIN_FAIL,
...
enum xrtErrorModule {
  ...
  XRT_ERROR_MODULE_KDS,
  XRT_ERROR_MODULE_XCLBIN,
