...
size() const
{
  ...
  typedef size_t (xrt::bo::*func_t)(void) const;
...
address() const
{
  ...
  typedef uint64_t (xrt::bo::*func_t)(void) const;
  xbtracer_proto::Func func_entry;
  proc_addr_type paddr_ptr;
  func_t ofunc = nullptr;
  void **ofunc_ptr = (void **)&ofunc;
...
wait()
{
  ...
  typedef void (xrt::bo::async_handle::*func_t)(void);
  xbtracer_proto::Func func_entry;
  proc_addr_type paddr_ptr;
  func_t ofunc = nullptr;
  void **ofunc_ptr = (void **)&ofunc;
...
map()
{
  ...
  typedef void* (xrt::bo::*func_t)(void);
  xbtracer_proto::Func func_entry;
  proc_addr_type paddr_ptr;
  func_t ofunc = nullptr;
  void **ofunc_ptr = (void **)&ofunc;
...
export_buffer()
{
  ...
  typedef xrt::bo::export_handle (xrt::bo::*func_t)(void);
  xbtracer_proto::Func func_entry;
  proc_addr_type paddr_ptr;
  func_t ofunc = nullptr;
  void **ofunc_ptr = (void **)&ofunc;
...
get_flags() const
{
  ...
  typedef xrt::bo::flags (xrt::bo::*func_t)(void) const;
  xbtracer_proto::Func func_entry;
  proc_addr_type paddr_ptr;
  func_t ofunc = nullptr;
  void **ofunc_ptr = (void **)&ofunc;
...
get_memory_group() const
{
  ...
  typedef xrt::memory_group (xrt::bo::*func_t)(void) const;
  xbtracer_proto::Func func_entry;
  proc_addr_type paddr_ptr;
  func_t ofunc = nullptr;
  void **ofunc_ptr = (void **)&ofunc;
