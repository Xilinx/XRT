...
SubCmdHotPlug::SubCmdHotPlug(bool _isHidden, bool _isDepricated, bool _isPreliminary)
    : SubCmd("configure",
...
void
SubCmdHotPlug::execute(const SubCmdOptions& _options) const
{
