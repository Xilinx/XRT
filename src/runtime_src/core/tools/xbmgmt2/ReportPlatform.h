...
class ReportPlatform: public Report {
 public:
  ReportPlatform() : Report("platform", "Platform information", true /*deviceRequired*/) { /*empty*/ };

 // Child methods that need to be implemented
 public:
  virtual void getPropertyTreeInternal(const xrt_core::device * _pDevice, boost::property_tree::ptree &_pt) const;
  virtual void getPropertyTree20201(const xrt_core::device * _pDevicee, boost::property_tree::ptree &_pt) const;
