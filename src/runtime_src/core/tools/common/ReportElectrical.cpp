                               ...
                               std::ostream & _output) const
{
  ...
  for(auto& kv : electricals) {
    ...
    if(pt_sensor.get<bool>("data_driven", false)) {
      ...
      bool volts_is_present = pt_sensor.get<bool>("voltage.is_present", false);
      bool amps_is_present = pt_sensor.get<bool>("current.is_present", false);
      bool power_is_present = pt_sensor.get<bool>("power.is_present", false);
      if(volts_is_present)
