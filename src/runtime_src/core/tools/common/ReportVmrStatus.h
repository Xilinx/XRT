...
#ifndef __ReportVmrStatus_h_
#define __ReportVmrStatus_h_

// Please keep external include file dependencies to a minimum
#include "Report.h"

class ReportVmrStatus : public Report {
 public:
  ReportVmrStatus() : Report("vmr", "Vmr status on the device", true /*deviceRequired*/) { /*empty*/ };
