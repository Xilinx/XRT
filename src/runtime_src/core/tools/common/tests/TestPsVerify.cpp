...
TestPsVerify::run(const std::shared_ptr<xrt_core::device>& dev)
{
...
void
TestPsVerify::runTest(const std::shared_ptr<xrt_core::device>& dev, boost::property_tree::ptree& ptree)
{
