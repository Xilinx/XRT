...
#ifndef __ReportRyzenPlatform_h_
#define __ReportRyzenPlatform_h_

// Please keep external include file dependencies to a minimum
#include "tools/common/Report.h"

class ReportRyzenPlatform : public Report {
 public:
  ReportRyzenPlatform() : Report("platform", "Platforms flashed on the device", true /*deviceRequired*/) { /*empty*/ };
