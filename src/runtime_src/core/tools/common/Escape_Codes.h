...
#define EC_CYAN  6
#define EC_WHITE  7
#define EC_BRIGHT_BLACK 8
#define EC_BRIGHT_RED  9
#define EC_BRIGHT_GREEN  10
#define EC_BRIGHT_YELLOW  11
#define EC_BRIGHT_BLUE  12
#define EC_BRIGHT_MAGENTA  13
#define EC_BRIGHT_CYAN  14
#define EC_BRIGHT_WHITE  15
...
void get_console_info(int *rows, int *cols)
{
