...
#ifndef __XILINX_XDP_PERF_COUNTERS_H
#define __XILINX_XDP_PERF_COUNTERS_H
...
namespace XDP {
  ...
  public:
    ...
    void writeTopUsageSummary(WriterI* writer) const;
  ...
  public:
    ...
    void logComputeUnitStats(const std::string& cuName, const std::string& kernelName, const std::string& deviceName,
                             double totalTimeStat, double maxTimeStat, double minTimeStat, uint32_t totalCalls,
  ...
  private:
	void writeBufferStat(WriterI* writer, const std::string transferType,
