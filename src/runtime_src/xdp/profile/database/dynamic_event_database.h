...
namespace xdp {
  ...
  private:
    ...
    std::map<uint64_t, AIETraceDataType > aieTraceData;
  ...
  public:
    ...
    XDP_EXPORT void addAIETraceData(uint64_t deviceId, void* buffer, uint64_t bufferSz);
    XDP_EXPORT AIETraceDataType getAIETraceData(uint64_t deviceId);
