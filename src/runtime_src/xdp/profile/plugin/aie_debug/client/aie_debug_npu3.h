...
#ifndef AIE_DEBUG_NPU3_H
#define AIE_DEBUG_NPU3_H
...
namespace xdp {
  ...
  class AieDebug_NPU3Impl : public AieDebugImpl {
  public:
    AieDebug_NPU3Impl(VPDatabase* database, std::shared_ptr<AieDebugMetadata> metadata);
    ~AieDebug_NPU3Impl() = default;
    void updateDevice();
