...
namespace xdp {
   ...
   * Client constructor
   ***************************************************************************/
  AieDebug_NPU3Impl::AieDebug_NPU3Impl(VPDatabase* database, std::shared_ptr<AieDebugMetadata> metadata)
   ...
   * Poll all registers
   ***************************************************************************/
  void AieDebug_NPU3Impl::poll(const uint64_t deviceID, void* /*handle*/)
  {
   ...
   * Update device
   ***************************************************************************/
  void AieDebug_NPU3Impl::updateDevice()
  {
    // Do nothing for now
  }
   ...
   * Update AIE device
   ***************************************************************************/
  void AieDebug_NPU3Impl::updateAIEDevice(void* /*handle*/)
  {
