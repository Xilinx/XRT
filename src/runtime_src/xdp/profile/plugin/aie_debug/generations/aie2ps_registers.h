...
// Status bits for Parity errors on stream switch ports (error on lower OR upper 32-bit word)
...
// Defeaured this generation. Status of Stream Switch Adaptive Clock Gate Status
const unsigned int cm_stream_switch_adaptive_clock_gate_status = 0x0003ff34;
// Defeaured this generation. Set Stream Switch Adaptive Clock Gate Abort Period
...
// Tile control register (Isolation)
const unsigned int cm_tile_control = 0x00060020;

// Register definitions for memory module
// ######################################
// Performance Counters 1-0 Start and Stop Event
const unsigned int mm_performance_control0 = 0x00011000;
// Performance Counters 1-0 Reset Event
...
// Performance Counters 5-4 Reset Event
...
// Defeatured this generation. Status of Stream Switch Adaptive Clock Gate Abort Period
...
// Register definitions for interface tile
// #######################################
...
// Interrupt controller 2nd level mask (IMR) (noc_module_0 Only)
const unsigned int shim_interrupt_controller_2nd_level_mask = 0x00001000;
// Interrupt controller 2nd level enable interrupt (IER) (noc_module_0 Only)
const unsigned int shim_interrupt_controller_2nd_level_enable = 0x00001004;
// Interrupt controller 2nd level disable interrupt (IDR) (noc_module_0 Only)
const unsigned int shim_interrupt_controller_2nd_level_disable = 0x00001008;
// Interrupt controller 2nd level status register (ISR) (noc_module_0 Only)
const unsigned int shim_interrupt_controller_2nd_level_status = 0x0000100c;
// Interrupt controller 2nd level interrupt (privileged) (noc_module_0 Only)
const unsigned int shim_interrupt_controller_2nd_level_interrupt = 0x00001010;
// AXI-MM NSU Bridge configuration (privileged) (only valid in noc_module_0 instance and shim tiles with NSU connection)
const unsigned int shim_me_aximm_config = 0x00002100;
// Configuration of multiplexer of tile input streams
const unsigned int shim_mux_config = 0x00002104;
// Configuration of demultiplexer of tile output streams
const unsigned int shim_demux_config = 0x00002108;
// AXI-MM outstanding transactions monitor
const unsigned int shim_axi_mm_outstanding_transactions = 0x00002120;
// SMID bits (privileged)
