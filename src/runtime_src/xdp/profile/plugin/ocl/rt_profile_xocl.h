...
#ifndef xdp_profile_rt_profile_xocl_h_
#define xdp_profile_rt_profile_xocl_h_

/**
 * This file contains xocl core object helper code for profiling
 *
 * Much of this code used to be member functions of a special
 * profile core derived classes, but that is not allowed and much
 * too intrusive.
 */
