...
namespace xdp {
  ...
  unsigned XoclPlugin::getProfileNumberSlots(xclPerfMonType type, const std::string& deviceName)
  {
  ...
  unsigned XoclPlugin::getProfileSlotProperties(xclPerfMonType type, const std::string& deviceName,
                                                unsigned slotnum)
  {
