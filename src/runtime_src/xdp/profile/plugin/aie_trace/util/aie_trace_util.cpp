...
namespace xdp::aie::trace {
  ...
  getMemoryEventSets(int hwGen)
  {
    ...
    if (xdp::aie::isAIE1(hwGen)) {
      ...
      eventSets["s2mm_channels_stalls"] =
         {XAIE_EVENT_DMA_S2MM_0_START_BD_CORE,              XAIE_EVENT_DMA_S2MM_0_FINISHED_BD_CORE,
          XAIE_EVENT_DMA_S2MM_0_STALLED_LOCK_CORE,          XAIE_EVENT_DMA_S2MM_0_MEMORY_BACKPRESSURE_CORE,
          XAIE_EVENT_DMA_S2MM_1_START_BD_CORE,              XAIE_EVENT_DMA_S2MM_1_FINISHED_BD_CORE,
          XAIE_EVENT_DMA_S2MM_1_STALLED_LOCK_CORE,          XAIE_EVENT_DMA_S2MM_1_MEMORY_BACKPRESSURE_CORE};
      eventSets["mm2s_channels_stalls"] =
         {XAIE_EVENT_DMA_MM2S_0_START_BD_CORE,              XAIE_EVENT_DMA_MM2S_0_FINISHED_BD_CORE,
          XAIE_EVENT_DMA_MM2S_0_STREAM_BACKPRESSURE_CORE,   XAIE_EVENT_DMA_MM2S_0_MEMORY_STARVATION_CORE};
#endif
    }
