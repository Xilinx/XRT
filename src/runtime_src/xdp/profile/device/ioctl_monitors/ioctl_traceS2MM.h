...
#ifndef XDP_PROFILE_DEVICE_IOCTL_TRACES2MM_H
#define XDP_PROFILE_DEVICE_IOCTL_TRACES2MM_H

#include "xdp/profile/device/traceS2MM.h"

namespace xdp {

/** Specialization for IOCtlTraceS2MM Profile IP with support for open+ioctl on device driver based IOCtlTraceS2MM subdevice
 */

class IOCtlTraceS2MM : public TraceS2MM
{
public:
  IOCtlTraceS2MM(Device*  handle  /* XDP Device Abstraction handle : xrt or HAL device handle */
