...
#ifndef XDP_PROFILE_DEVICE_IOCTL_AIM_H
#define XDP_PROFILE_DEVICE_IOCTL_AIM_H

#include "xdp/profile/device/aim.h"

namespace xdp {

/** Specialization for AIM Profile IP with support for open+ioctl on device driver based AIM subdevice
 */

class IOCtlAIM : public AIM
{
public:
  IOCtlAIM(Device*  handle  /* XDP Device Abstraction handle : xrt or HAL device handle */
