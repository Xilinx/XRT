...
#ifndef XDP_PROFILE_DEVICE_IOCTL_TRACEFUNNEL_H
#define XDP_PROFILE_DEVICE_IOCTL_TRACEFUNNEL_H

#include "xdp/profile/device/traceFunnel.h"

namespace xdp {

/** Specialization for IOCtlTraceFunnel Profile IP with support for open+ioctl on device driver based IOCtlTraceFunnel subdevice
 */

class IOCtlTraceFunnel : public TraceFunnel
{
public:
