...
#ifndef XDP_PROFILE_DEVICE_ADD_H
#define XDP_PROFILE_DEVICE_ADD_H
...
/**
 * Accel Deadlock Detector ProfileIP (IP with safe access) : ACCEL DEADLOCK
 * 
 * Description:
 * 
 ...
 */
class DeadlockDetector : public ProfileIP {
public:
