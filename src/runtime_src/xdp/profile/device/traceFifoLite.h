...
#ifndef XDP_PROFILE_DEVICE_TRACE_FIFO_LITE_H
#define XDP_PROFILE_DEVICE_TRACE_FIFO_LITE_H
...
/**
 * TRACE FIFO LITE ProfileIP (IP with safe access) : FIFO CONTROL
 * 
 * Description:
 * 
 ...
 */
class TraceFifoLite : public ProfileIP {
public:
     ...
     */
    TraceFifoLite(Device* handle /** < [in] the xrt or hal device handle */, 
