...
#define TS2MM_WARN_MSG_BUFSIZE_BIG    "Trace Buffer size too big. The MAX size of 15G will be used"
#define TS2MM_WARN_MSG_BUFSIZE_SMALL  "Trace Buffer size too small. The MIN size of 8K will be used"
