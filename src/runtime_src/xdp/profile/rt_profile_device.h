 ...
 *
 *  @details
 *  This class enables access, reporting, and analysis of device profiling.
 *  This includes the sampled metric counters and the event trace stream
 *  in the APM.
 *
...
#ifndef _XILINX_RT_PROFILE_DEVICE_H
#define _XILINX_RT_PROFILE_DEVICE_H
