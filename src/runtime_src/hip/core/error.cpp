...
namespace xrt::core::hip
{
  ...
  error::instance()
  {
    thread_local static error hip_error_state;
  ...
  get_last_error()
  {
    ...
    return update_last_error_nolock();
  }
  ...
  peek_last_error()
  {
    ...
    m_hip_last_error = update_last_error_nolock();
    return m_hip_last_error;
  }
  ...
  const static std::map<int, hipError_t> sys_to_hip_error_map =
  {
  #ifdef __linux__
