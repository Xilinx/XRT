...
if(NOT WIN32)
  ...
  if (CMAKE_CROSSCOMPILING AND CMAKE_SYSROOT)
    ...
    list(APPEND CMAKE_MODULE_PATH
      "${CMAKE_SYSROOT}/usr/lib/x86_64-linux-gnu/cmake/hip"
      "${CMAKE_SYSROOT}/usr/lib/x86_64-linux-gnu/cmake/amd_comgr"
    ...
    list(APPEND CMAKE_PREFIX_PATH
      "${CMAKE_SYSROOT}/usr/lib/x86_64-linux-gnu/cmake/hip"
      "${CMAKE_SYSROOT}/usr/lib/x86_64-linux-gnu/cmake/amd_comgr"
      "${CMAKE_SYSROOT}/usr/lib/x86_64-linux-gnu/cmake/hsa-runtime64"
      "${CMAKE_SYSROOT}/opt/rocm/lib/cmake/hip"
      "${CMAKE_SYSROOT}/opt/rocm/lib/cmake/amd_comgr"
    ...
    # We should find HIP cmake either in standard cmake locations or in the /opt/rocm location
    list(APPEND CMAKE_MODULE_PATH
      "/usr/lib/x86_64-linux-gnu/cmake/hip"
      "/usr/lib/x86_64-linux-gnu/cmake/amd_comgr"
