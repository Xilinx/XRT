  ...
  void load_xdp_lop()
  {
	...
	if (xrt::config::get_profile())
	{
	  xrt::message::send(xrt::message::severity_level::XRT_WARNING,
			     "Both low overhead profiling and OpenCL profile summary generation are enabled.  The trace generated by low overhead profiling will reflect the higher overhead associated with profile summary generation.") ;
	}
      }
      ~xdp_lop_once_loader()
      {
