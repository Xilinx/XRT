...
void setup_ert_hw(struct drm_zocl_dev *zdev)
{
  ...
  /* Enable cu interupts (cu -> cu_isr -> PS interrupt) */
	...
	//TODO: Microblaze is not enable this feature today. Let's see.
