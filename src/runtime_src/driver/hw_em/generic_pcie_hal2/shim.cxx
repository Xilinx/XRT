...
size_t HwEmShim::xclWriteBO(unsigned int boHandle, const void *src, size_t size, size_t seek)
{
  ...
  size_t returnVal = xclCopyBufferHost2Device( bo->base, src, size,seek,bo->topology);
  PRINTENDFUNC;
  return returnVal;
}
/***************************************************************************************/
...
size_t HwEmShim::xclReadBO(unsigned int boHandle, void *dst, size_t size, size_t skip)
{
  ...
  size_t returnVal = xclCopyBufferDevice2Host(dst, bo->base, size, skip, bo->topology);
  PRINTENDFUNC;
  return returnVal;
}
/***************************************************************************************/
