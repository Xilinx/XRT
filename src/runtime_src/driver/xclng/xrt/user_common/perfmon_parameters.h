...
#define XSPM_SAMPLE_OUTSTANDING_COUNTS_UPPER_OFFSET  0xD8
#define XSPM_SAMPLE_LAST_WRITE_ADDRESS_UPPER_OFFSET  0xDC
#define XSPM_SAMPLE_LAST_WRITE_DATA_UPPER_OFFSET     0xE0
#define XSPM_SAMPLE_LAST_READ_ADDRESS_UPPER_OFFSET   0xE4
#define XSPM_SAMPLE_LAST_READ_DATA_UPPER_OFFSET      0xE8
