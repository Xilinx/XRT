...
if (${LINUX_FLAVOR} STREQUAL Ubuntu)
  ...
  SET(CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA "${CMAKE_CURRENT_BINARY_DIR}/xrt-aws-prep/postinst-aws;${CMAKE_CURRENT_BINARY_DIR}/xrt-aws-prep/prerm-aws")
...
elseif (${LINUX_FLAVOR} MATCHES "^(RedHat|CentOS)")
  ...
  SET(CPACK_RPM_POST_INSTALL_SCRIPT_FILE "${CMAKE_CURRENT_BINARY_DIR}/xrt-aws-prep/postinst-aws")
  SET(CPACK_RPM_PRE_UNINSTALL_SCRIPT_FILE "${CMAKE_CURRENT_BINARY_DIR}/xrt-aws-prep/prerm-aws")
...
message("-- AWS-------${CMAKE_BUILD_TYPE} ${PACKAGE_KIND} package")
