...
elseif (${LINUX_FLAVOR} MATCHES "^(RedHat|CentOS)")
  ...
  # xrt component dependencies
  SET(CPACK_RPM_XRT_PACKAGE_REQUIRES "ocl-icd-devel >= 2.2, boost-devel >= 1.53, boost-filesystem >= 1.53, libuuid-devel >= 2.23.2, dkms >= 2.5.0, protobuf-devel >= 2.5.0, protobuf-compiler >= 2.5.0, ncurses-devel >= 5.9, redhat-lsb-core, libxml2-devel >= 2.9.1, libyaml-devel >= 0.1.4, python >= 3.5, python3-pip, openssl-devel >= 1.0.2 ")
else ()
