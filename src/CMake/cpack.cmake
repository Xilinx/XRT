...
if (${LINUX_FLAVOR} STREQUAL Ubuntu)
  ...
  set(CPACK_DEBIAN_PACKAGE_DEPENDS "ocl-icd-opencl-dev (>= 2.2.0), libboost-dev (>=1.58), libboost-filesystem-dev (>=1.58), uuid-dev (>= 2.27.1), dkms (>= 2.2.0), libprotoc-dev (>=2.6.1), protobuf-compiler (>=2.6.1), libncurses5-dev (>=6.0), libxml2-dev (>=2.9.1), libyaml-dev (>= 0.1.6)")
elseif (${LINUX_FLAVOR} MATCHES "^(RedHat|CentOS)")
  ...
  set(CPACK_RPM_PACKAGE_REQUIRES "ocl-icd-devel >= 2.2, boost-devel >= 1.53, boost-filesystem >= 1.53, libuuid-devel >= 2.23.2, dkms >= 2.5.0, protobuf-devel >= 2.5.0, protobuf-compiler >= 2.5.0, ncurses-devel >= 5.9, libxml2-devel >= 2.9.1, libyaml-devel >= 0.1.4 ")
else ()
