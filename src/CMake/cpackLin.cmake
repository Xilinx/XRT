...
elseif (${LINUX_FLAVOR} MATCHES "^(RedHat|CentOS|Amazon|SUSE)")
  ...
  if (${LINUX_FLAVOR} MATCHES "^(SUSE)")
    SET(CPACK_RPM_XRT_PACKAGE_REQUIRES "ocl-icd-devel >= 2.2, libboost_filesystem1_66_0-devel, libuuid-devel >= 2.23.2, dkms >= 2.2.0, protobuf-devel >= 2.5.0, ncurses-devel >= 5.9, lsb-release, libxml2-devel >= 2.9.1, libyaml-devel >= 0.1.4, python >= 2.7, python3-pip, python2-pip, libopenssl-devel >= 1.0.2, libudev-devel ")
  else ()
