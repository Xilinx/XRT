...
elseif (${LINUX_FLAVOR} MATCHES "^(RedHat|CentOS|Amazon)")
  ...
  SET(CPACK_RPM_XRT_PACKAGE_REQUIRES "ocl-icd-devel >= 2.2, boost-devel >= 1.53, boost-filesystem >= 1.53, boost-program-options >= 1.53, libuuid-devel >= 2.23.2, dkms >= 2.5.0, protobuf-devel >= 2.5.0, protobuf-compiler >= 2.5.0, ncurses-devel >= 5.9, redhat-lsb-core, libxml2-devel >= 2.9.1, libyaml-devel >= 0.1.4, openssl-devel >= 1.0.2, libudev-devel ")
  if (${LINUX_VERSION} VERSION_LESS "8.0.0")
    STRING(APPEND CPACK_RPM_XRT_PACKAGE_REQUIRES ", python >= 2.7, python-pip")
  else()
    STRING(APPEND CPACK_RPM_XRT_PACKAGE_REQUIRES ", python3 >= 3.6, python3-pip")
  endif()
else ()
