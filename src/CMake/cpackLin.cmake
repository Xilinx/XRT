...
if (NOT DEFINED NPU)
  ...
  SET(NO_NPU_CPACK_PACKAGE_FILE_NAME ${CPACK_PACKAGE_FILE_NAME})
  SET(CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_FILE_NAME}-npu")
  add_custom_target(xrtpkg
    echo "COMMAND ${CMAKE_CPACK_COMMAND}"
    COMMAND ${CMAKE_CPACK_COMMAND}
    COMMAND -mv -f ${NO_NPU_CPACK_PACKAGE_FILE_NAME}-npu.deb ${NO_NPU_CPACK_PACKAGE_FILE_NAME}.deb 2> /dev/null
    COMMAND -mv -f ${NO_NPU_CPACK_PACKAGE_FILE_NAME}-npu.rpm ${NO_NPU_CPACK_PACKAGE_FILE_NAME}.rpm 2> /dev/null
    COMMAND -mv -f ${NO_NPU_CPACK_PACKAGE_FILE_NAME}-npu.tar.gz ${NO_NPU_CPACK_PACKAGE_FILE_NAME}.tar.gz 2> /dev/null

  )
endif(NOT DEFINED NPU)
