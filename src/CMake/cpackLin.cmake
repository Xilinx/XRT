...
elseif (${LINUX_FLAVOR} MATCHES "^(RedHat|CentOS|Amazon|SUSE)")
  execute_process(
    COMMAND uname -m
    OUTPUT_VARIABLE CPACK_ARCH
    OUTPUT_STRIP_TRAILING_WHITESPACE
  ...
  if (${LINUX_FLAVOR} MATCHES "^(SUSE)")
    SET(CPACK_RPM_XRT_PACKAGE_REQUIRES "ocl-icd-devel >= 2.2, boost-devel >= 1.53, boost-filesystem >= 1.53, libuuid-devel >= 2.23.2, dkms >= 2.5.0, protobuf-devel >= 2.5.0, protobuf-compiler >= 2.5.0, ncurses-devel >= 5.9, lsb-release, libxml2-devel >= 2.9.1, libyaml-devel >= 0.1.4, python >= 2.7, python-pip, openssl-devel >= 1.0.2, libudev-devel ")
  else ()
