...
proc create_hier_cell_pr_isolation_expanded { parentCell nameHier } {
  ...
  connect_bd_net -net psreset_regslice_pr_interconnect_aresetn [get_bd_pins psreset_regslice_data_pr_interconnect_aresetn] [get_bd_pins axi_register_slice_0/aresetn] [get_bd_pins axi_register_slice_1/aresetn] [get_bd_pins psreset_regslice_data_pr/peripheral_aresetn] [get_bd_pins regslice_control_userpf/aresetn] [get_bd_pins regslice_ddrmem_2/aresetn] [get_bd_pins regslice_ddrmem_3/aresetn]
  connect_bd_net -net psreset_regslice_data_pr_interconnect_aresetn1 [get_bd_pins psreset_regslice_data_pr/interconnect_aresetn] [get_bd_pins regslice_data_periph_1/aresetn]
...
proc create_root_design { parentCell } {
  ...
  assign_bd_address -offset 0x80030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces static_region/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs static_region/base_clocking/clkwiz_kernel/s_axi_lite/Reg] -force
