...
proc add_interrupt_ctrl_concat { __cu_num } {
  ...
  foreach __pair $__inst_intrs_list {
    ...
    if {[llength $__xlconcat_pin] == 1} {
      ...
      apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {Auto} Clk_slave {Auto} Clk_xbar {Auto} Master {/ps7/M_AXI_GP0} Slave {/axi_intc_${__intc_inst_num}/s_axi} intc_ip {Auto} master_apm {0}}  [get_bd_intf_pins axi_intc_${__intc_inst_num}/s_axi]
