...
proc create_hier_cell_interrupt_concat { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir O -from 31 -to 0 -type intr xlconcat_interrupt_dout
...
proc create_root_design { parentCell } {
  ...
  set xlconcat_interrupt_dout [ create_bd_port -dir O -from 31 -to 0 -type intr xlconcat_interrupt_dout ]
