...
config_dts()
{
	...
	echo "cat ${THIS_CONFIG_SCRIPT_DIR}//xlnk_dts_fragment_mpsoc.dts >> $DTS_FILE"
	cat ${THIS_CONFIG_SCRIPT_DIR}/xlnk_dts_fragment_mpsoc.dts >> recipes-bsp/device-tree/files/system-user.dtsi
