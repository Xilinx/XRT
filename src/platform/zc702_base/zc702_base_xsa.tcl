...
proc create_root_design { parentCell } {
  ...
  set_property PFM.CLOCK {clk_out1 {id "0" is_default "true" proc_sys_reset "proc_sys_reset_0" status "scalable"} clk_out2 {id "1" is_default "false" proc_sys_reset "proc_sys_reset_1" status "scalable"} } [get_bd_cells /clk_wiz_0]
