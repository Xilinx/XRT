...
################################################################
# This is a generated script based on design: zcu104_revmin
#
...
# source zcu104_revmin_script.tcl
...
if { $list_projs eq "" } {
   create_project zcu104_revmin zcu104_revmin -part xczu7ev-ffvc1156-2-e
...
set_property SELECTED_SIM_MODEL tlm_dpi [get_bd_cells /ps_e]
  ...
  set_property PFM_NAME {xilinx.com:zcu104:zcu104_revmin:1.0} [get_files [current_bd_design].bd]
...
generate_target  all  [get_files  ./zcu104_revmin/zcu104_revmin.srcs/sources_1/bd/zcu104_revmin/zcu104_revmin.bd]
set_property generate_synth_checkpoint true [get_files -norecurse *.bd]
make_wrapper -files [get_files ./zcu104_revmin/zcu104_revmin.srcs/sources_1/bd/zcu104_revmin/zcu104_revmin.bd] -top
add_files -norecurse ./zcu104_revmin/zcu104_revmin.srcs/sources_1/bd/zcu104_revmin/hdl/zcu104_revmin_wrapper.v
...
file mkdir ./zcu104_revmin/zcu104_revmin.sdk
write_hwdef -force  -file ./zcu104_revmin/zcu104_revmin.sdk/zcu104_revmin_wrapper.hdf
#file copy -force ./zcu104_revmin/zcu104_revmin.runs/impl_1/zcu104_wrapper.sysdef ./zcu104_revmin/zcu104_revmin.sdk/zcu104_wrapper.hdf

set_property platform.post_sys_link_tcl_hook ./dynamic_postlink.tcl [current_project]

write_hw_platform -unified -include_bit ./zcu104_revmin.xsa
validate_hw_platform ./zcu104_revmin.xsa
