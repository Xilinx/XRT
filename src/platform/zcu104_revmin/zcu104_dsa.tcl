#create design
create_project zcu104 ./zcu104_vivado -force -part xczu7ev-ffvc1156-2-e
set_property board_part [get_board_parts *:zcu104:* -latest_file_version] [current_project]
create_bd_design "zcu104"
make_wrapper -files [get_files ./zcu104_vivado/zcu104.srcs/sources_1/bd/zcu104/zcu104.bd] -top
add_files -norecurse ./zcu104_vivado/zcu104.srcs/sources_1/bd/zcu104/hdl/zcu104_wrapper.v
...
#create pfm
set_property PFM_NAME "xilinx.com:zcu104:zcu104:1.0" [get_files ./zcu104_vivado/zcu104.srcs/sources_1/bd/zcu104/zcu104.bd]
...
set_property PFM.AXI_PORT { \
	M_AXI_HPM0_FPD {memport "M_AXI_GP" sptag "GP"} \
	M_AXI_HPM1_FPD {memport "M_AXI_GP" sptag "GP"} \
	M_AXI_HPM0_LPD {memport "M_AXI_GP" sptag "GP"} \
	S_AXI_HPC0_FPD {memport "S_AXI_HPC" sptag "HPC" memory "ps_e HPC0_DDR_LOW"} \
	S_AXI_HPC1_FPD {memport "S_AXI_HPC" sptag "HPC" memory "ps_e HPC1_DDR_LOW"} \
	S_AXI_HP0_FPD {memport "S_AXI_HP" sptag "HP" memory "ps_e HP0_DDR_LOW"} \
	S_AXI_HP1_FPD {memport "S_AXI_HP" sptag "HP" memory "ps_e HP1_DDR_LOW"} \
	S_AXI_HP2_FPD {memport "S_AXI_HP" sptag "HP" memory "ps_e HP2_DDR_LOW"} \
	S_AXI_HP3_FPD {memport "S_AXI_HP" sptag "HP" memory "ps_e HP3_DDR_LOW"} \
	} [get_bd_cells /ps_e]
set intVar []
...
##spit out a DSA
generate_target all [get_files ./zcu104_vivado/zcu104.srcs/sources_1/bd/zcu104/zcu104.bd]
set_property dsa.post_sys_link_tcl_hook        ./dynamic_postlink.tcl       [current_project]
write_dsa -force ./zcu104.dsa


#generate hdf
write_hwdef -force  -file ./zcu104_vivado/zcu104.hdf
