#create design
create_project zcu104_revmin ./zcu104_revmin_vivado -force -part xczu7ev-ffvc1156-2-e
set_property board_part [get_board_parts *:zcu104:* -latest_file_version] [current_project]
create_bd_design "zcu104_revmin"
make_wrapper -files [get_files ./zcu104_revmin_vivado/zcu104_revmin.srcs/sources_1/bd/zcu104_revmin/zcu104_revmin.bd] -top
add_files -norecurse ./zcu104_revmin_vivado/zcu104_revmin.srcs/sources_1/bd/zcu104_revmin/hdl/zcu104_revmin_wrapper.v
...
#create pfm
set_property PFM_NAME "xilinx.com:zcu104:zcu104:1.0" [get_files ./zcu104_revmin_vivado/zcu104_revmin.srcs/sources_1/bd/zcu104_revmin/zcu104_revmin.bd]
...
##spit out a DSA
generate_target all [get_files ./zcu104_revmin_vivado/zcu104_revmin.srcs/sources_1/bd/zcu104_revmin/zcu104_revmin.bd]
set_property dsa.post_sys_link_tcl_hook        ./dynamic_postlink.tcl       [current_project]
#write_dsa -force ./zcu104_revmin.dsa
write_dsa -unified -include_bit -include_emulation -force ./zcu104_revmin.dsa

#generate hdf
write_hwdef -force -file ./zcu104_revmin_vivado/zcu104_revmin.hdf
